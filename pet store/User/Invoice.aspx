<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Invoice.aspx.cs" Inherits="pet_store.User.Invoice" %>
    ...
    <section class="book_section layout_padding">
        ...
        <div class="container">
            ...
            <div class="w-100 d-flex flex-row justify-content-end">
                <asp:Label ID="Label_TotalPrice" runat="server" CssClass="labelSsrFont text-right py-1"><%# Eval("TotalPrice") %></asp:Label>
            </div>
