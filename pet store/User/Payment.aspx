<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="pet_store.User.Payment" %>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8">
                                                <div class="form-group">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="rfvExpMonth" runat="server" ErrorMessage="Expire month is required"
                                                    ...
                                                    <asp:RequiredFieldValidator ID="rfvExpYear" runat="server" ErrorMessage="Expire year is required"
