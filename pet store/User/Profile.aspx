<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="pet_store.User.Profile" %>
                                ...
                                <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active text-info" id="basicInfo-tab"
                                            data-toggle="tab" href="#basicInfo" role="tab" aria-controls="basicInfo" aria-selected="true">
                                ...
                                <div class="tab-content ml-1" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade" id="connectedServices" role="tabpanel" aria-labelledby="ConnectedServices-tab">
                                        ...
                                        <%--                                        <asp:Repeater ID="rPurchaseHistory" runat="server">
                                            <ItemTemplate>
                                                <div class="container">
                                                    <div class="row pt-1 pb-1" style="background-color: lightblue">
                                                        <div class="col-4">
                                                            <span class="badge badge-pill badge-dark text-white">
                                                                <%# Eval("SrNo") %>
                                                            </span>
                                                            Payment Method: <%# Eval("PaymentMethod").ToString() == "cod" ? "Cash On Delivery" : Eval("PaymentMethod").ToString().ToUpper()%>
                                                        </div>
                                                        <div class="col-6">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:Label ID="lblQuatity" runat="server" Text='<%# Eval("Quatity") %>'></asp:Label>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <asp:Label ID="Label_PaymentMethod" runat="server" Text='<%# Eval("PaymentMethod").ToString() == "cod" ? "Cash On Delivery" : Eval("PaymentMethod").ToString().ToUpper()%>' />
                                                    </td>
                                                    <td>
                                                        <a href="Invoice.aspx?id=<%# Eval("PaymentId") %>" class="btn btn-info btn-sm"><i class="fa fa-download mr-2"></i>Invoice</a>
                                                    </td>
